# Fiches Personas
### Les 3 utilisateurs cibles d'EduTutor IA, dimensions de référence
...
> 💡 Convention de nommage du fichier : `equipe-XX-nom-document-vY.Z.docx` (ex. `equipe-03-persona-v1.0.docx`)

---

## Table des matières

1. [Persona primaire, Étudiant·e du supérieur](#1-persona-primaire-étudiante-du-supérieur)
   - 1.1. Identité
...
2. [Persona secondaire, Enseignant·e (persona émergente J1)](#2-persona-secondaire-enseignante-persona-émergente-j1)
   - 2.1. Identité
...
Ce modèle contient 3 personas couvrant les 3 cibles du Product Vision Board : l'étudiant·e (cible primaire), l'enseignant·e (cible secondaire émergente lors de la perturbation J1), et l'établissement scolaire (cible tertiaire B2B). Pour chaque persona, 6 dimensions sont à compléter, plus une mini-section « anti-persona » qui clarifie qui le produit ne sert volontairement PAS.

> 💡 **Mode d'emploi** — Travaillez en binôme minimum, jamais en solo (biais de projection). Les amorces (Léa Martin, Mme Lefèvre) sont des points de départ, vous affinez avec vos propres hypothèses, vos chiffres, votre contexte d'équipe.

---

## 1. Persona primaire, Étudiant·e du supérieur

> 💡 **Objectif.** Décrire l'utilisateur principal du produit (celui qui ouvre l'app au quotidien) avec un niveau de concrétude suffisant pour qu'on "voie" la personne.
>
> 💡 **Format attendu.** 6 dimensions standard : identité · contexte · compétences · frustrations · objectifs · critères de succès. Frustrations et objectifs chiffrés autant que possible.
>
> ✅ **Bon exemple.** « Léa Martin, 20 ans, L2 droit Paris II. Smartphone Android personnel (Samsung A53). Révise 8h/semaine, dont 3h perdues à chercher des fiches. »
>
> ❌ **À éviter.** « Une étudiante. Elle veut réviser. » (générique, intestable, ne tranche aucun arbitrage)

### 1.1. Identité

| Champ | Valeur |
|---|---|
| **Nom / Prénom** | Léa Martin (fictif, à adapter selon votre équipe) |
| **Âge** | 20 ans |
...
- Révise environ 10h à 12h par semaine au total, principalement sur son smartphone dans les transports ou sur table en BU
...
- Utilise quotidiennement Notion pour trier ses cours, mais ne sait pas ce qu'est une API ou un environnement de développement
...
- Sur les applications de quiz classiques, elle tombe souvent sur des questions hors-sujet ou créées par d'autres étudiants, ce qui lui fait perdre du temps
...
- Obtenir un score minimal de 80% de bonnes réponses sur les quiz générés par l'IA d'ici la fin de sa première semaine de révisions

### 1.6. Critères de succès personnels (du point de vue persona)
...
- « Si l'application me propose des explications claires quand je me trompe à une question, je l'utilise tous les jours. »

---

## 2. Persona secondaire, Enseignant·e (persona émergente J1)

> 💡 **Objectif.** Décrire l'utilisateur secondaire qui émerge lors de la perturbation J1. Mme Lefèvre n'est pas la cible initiale, mais elle représente la cible B2B la plus crédible.
>
> 💡 **Format attendu.** Mêmes 6 dimensions que le persona primaire. Pain points et objectifs liés à l'enseignement, pas à la révision personnelle.
>
> ✅ **Bon exemple.** « Mme Sophie Lefèvre, 42 ans, prof BTS Communication Lyon. 28 étudiants, 6h/semaine, corrige 12h/mois. »
>
> ❌ **À éviter.** « Un prof. Il veut gagner du temps. » (sans contexte précis, pas exploitable)
...
- Prépare ses cours le soir chez elle sur son ordinateur portable personnel (Asus sous Windows 11), sur une connexion fibre
...
- Maîtrise les outils de visioconférence (Teams, Zoom) et sait générer des PDF, mais n'a jamais configuré de prompt d'IA de sa vie

### 2.4. Frustrations / pain points (chiffrés)

- Corrige 28 copies × 3 quizz / semaine = ~12h de correction / mois
- Préparation chronophage : créer 1 quiz cohérent prend ~90 minutes
...
- Passe près de 2 heures à chaque fin de chapitre pour imaginer des questions de quiz pièges mais justes pour ses élèves
...
- Réduire de 50% son temps de création d'évaluations mensuelles grâce à l'export direct des quiz générés par l'IA

### 2.6. Critères de succès personnels (du point de vue persona)
...
> 💡 **Objectif.** Décrire la personne qui décide de l'achat (différente de l'utilisateur). En éducation B2B, c'est souvent un·e responsable pédagogique ou un·e directeur·rice.
>
> 💡 **Format attendu.** 6 dimensions standard, avec focus sur le processus d'achat (budget, cycle, validations multiples).
>
> ✅ **Bon exemple.** « M. David Chen, 51 ans, directeur des études d'un lycée privé à Lyon. Décide pour 1 200 élèves. Cycle d'achat 6 mois minimum. »
>
> ❌ **À éviter.** « Un directeur. » (manque tout : décideur réel ? budget ? RGPD est-il un dealbreaker ? validation pédagogique ?)

### 3.1. Identité

| Champ | Valeur |
|---|---|
| **Nom / Prénom** | M. David Chen (fictif, à adapter) |
| **Âge** | 51 ans |
...
- Doit présenter un rapport trimestriel d'innovation pédagogique au conseil d'administration du groupe scolaire
...
- Consulte des tableaux de bord financiers et de présence, très sensible à la sécurité des données des mineurs

### 3.4. Frustrations / pain points

- A déjà signé pour 2 outils edtech qui ont fermé en cours d'année (risque pérennité)
- DPO refuse systématiquement les outils utilisant OpenAI ou des LLM US (transferts UE)
...
- Les outils d'IA du marché (américains) stockent les données hors d'Europe, ce qui bloque toutes ses demandes de budget auprès du DPO

### 3.5. Objectifs (jobs-to-be-done)

- Disposer d'un outil edtech IA RGPD conforme, signable sans risque juridique
- Tarification prévisible par élève / par an (pas de surprise au renouvellement)
- Adhésion d'au moins 30 % des profs dès la première année (sinon échec budgétaire)
- Déployer la solution sur 2 classes pilotes dès le premier mois pour valider l'infrastructure avant l'achat global
...
>
> 💡 **Format attendu.** 1 paragraphe par persona, décrivant un anti-utilisateur typique et pourquoi il est exclu.
>
> ✅ **Bon exemple.** « Anti-persona étudiant : élève de primaire. EduTutor exige un cours fourni en PDF/texte, niveau supérieur. Ne pas viser. »
>
> ❌ **À éviter.** « Tout le monde sauf nos cibles. » (vague, non actionnable)
