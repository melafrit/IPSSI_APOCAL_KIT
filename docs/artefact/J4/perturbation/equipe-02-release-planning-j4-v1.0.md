...
| **Sprint 4** | Mercredi matin | 9h00 – 12h30 | 24,5 | 8 | Sécurisation du moteur IA : correction de la prompt injection et validation des réponses générées. | US-07 (reset password), US-10 (mode chronométré), US-20 (patch prompt injection), US-21 (tests adversariaux), US-22 (validation post-LLM). | ⚡ Perturbation J3 à 10h |
| **Sprint 5** | Mercredi PM | 14h00 – 18h00 | 28 | 8 | Connexion sociale, suivi utilisateur et préparation de la conformité RGPD avant la Release MVP. | US-13 (Google/Apple), US-11 (dashboard progression), US-23 (analyse de conformité RGPD), US-24 (politique de rétention et planification de l'export des données). | ⚡ J3-bis 14h · 🚀 Release 1 (MVP) 17h45 |
| **Sprint 6** | Jeudi matin | 9h00 – 12h30 | 24,5 | 8 | Personnalisation, conformité RGPD, accessibilité RGAA et préparation à l'internationalisation. | US-09 (difficulté/nb questions), US-12 (export RGPD), US-17 (suppression compte), US-14 (import URL), US-25 (audit RGAA), US-26 (internationalisation FR/EN). | ⚡ Perturbation J4 à 10h |
| **Sprint 7** | Jeudi PM | 14h00 – 17h00 | 21 | 6–8 | Finalisation Release 2, optimisation des performances, validation RGAA et préparation de la démo finale. | US-16 (identification lacunes), US-15 (questions ouvertes IA), US-27 (tests de charge), US-28 (optimisation performances), US-29 (architecture scalable). | 🚀 Release 2 17h |
...
| Sprint 2 | Mar 12h30 | 16 | — | 60 + (ajout Benchmark IA + ADR) |
| Sprint 3 | Mar 18h | 24 | — | 60 |
| Sprint 4 | Mer 12h30 | 32 | — | 66 + (ajout Sécurité LLM)|
| Sprint 5 | Mer 18h | 40 | — | 70 + (ajout Conformité RGPD) |
| Sprint 6 | Jeu 12h30 | 48 | — | 82 + (ajout RGAA, i18n et Scalabilité) |
| Sprint 7 | Jeu 17h | 56 | — | 82 |
