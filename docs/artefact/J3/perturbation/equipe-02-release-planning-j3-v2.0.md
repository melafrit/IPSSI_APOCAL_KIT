...
| **Sprint 5** | Mercredi PM | 14h00 – 18h00 | 28 | 8 | Connexion sociale, suivi utilisateur et préparation de la conformité RGPD avant la Release MVP. | US-13 (Google/Apple), US-11 (dashboard progression), US-23 (export des données personnelles), US-24 (politique de rétention). | ⚡ J3-bis 14h · 🚀 Release 1 (MVP) 17h45 |
